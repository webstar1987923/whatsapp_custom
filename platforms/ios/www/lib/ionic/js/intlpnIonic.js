...
var intlpnCtrl = function( $ionicModal, $scope, intlpnUtils,UserService ) {
    var self = $scope;
    ...
    self._updateDialCode = function(newDialCode) {
        ...
        UserService.countrycode=newDialCode;
        //alert(newDialCode);
        if( self.national ) {
...
.directive('intlpn', function( $ionicModal, $timeout, $ionicScrollDelegate, UserService) {
           return {
           restrict: 'E',
           require: '^ngModel',
           scope: {
           ...
           UserService.country=country.name;
